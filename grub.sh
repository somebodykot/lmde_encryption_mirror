...
wget -O /mnt/tmp/ https://raw.githubusercontent.com/somebodykot/lmde_encryption_mirror/refs/heads/main/grub-install 
# Chroot 
...
echo "After chroot, enter command: cd /tmp; bash grub-install 1"
chroot /mnt
