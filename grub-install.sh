...
wget -O /mnt/tmp/grub-install.sh https://raw.githubusercontent.com/somebodykot/lmde_encryption_mirror/refs/heads/main/grub-install.sh
# Chroot 
...
echo "After chroot, enter command: cd /tmp; bash grub-install.sh 1"
chroot /mnt
...
git clone https://github.com/olafhering/grub.git # mirror https://git.savannah.gnu.org/git/grub.git
cd grub
git clone https://github.com/somebodykot/grub-extras.git # mirror https://git.savannah.nongnu.org/git/grub-extras.git
git clone https://github.com/somebodykot/grub-improved-luks2-git.git # https://aur.archlinux.org/grub-improved-luks2-git.git 
git clone https://github.com/coreutils/gnulib.git # mirror https://git.savannah.gnu.org/git/gnulib.git 
